...
@javax.persistence.Table(name="promocomments", schema="promo", catalog="")
public class PromocommentsEntity {
  private int id;
  private String comment;
  private Timestamp time;
  
  public PromocommentsEntity() {}
  ...
  public boolean equals(Object o)
  {
    ...
    PromocommentsEntity that = (PromocommentsEntity)o;
